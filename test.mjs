...
assert.equal(directed[1].pitch, 1);
...
assert.equal(atmosphericDirection[1].pitch, -1);
...
assert.equal(tts28Body.voice_setting.pitch, 1);
...
assert.equal(invalidParamsBody.voice_setting.pitch, -1);
